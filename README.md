In confidence - Eel Pie Consulting Limited.
This document describes a private API.
...
Consuming social media content has become increasing difficult due to complicated authentication and rate limiting requirements. 
