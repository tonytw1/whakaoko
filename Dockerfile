...
COPY certs/gdidg2.crt gdidg2.crt
...
RUN /usr/bin/keytool -import -alias gdidg2 -keystore /usr/lib/jvm/java-11-openjdk-amd64/lib/security/cacerts -file gdig2.crt -noprompt -storepass changeit
