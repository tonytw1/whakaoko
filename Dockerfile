...
CMD ["java", "-XshowSettings:system", "-XX:+PrintCommandLineFlags", "-XX:MaxRAMPercentage=75","-jar","/opt/whakaoko/whakaoko-0.0.1-SNAPSHOT.jar", "--spring.config.location=/opt/whakaoko/conf/whakaoko.properties"]
