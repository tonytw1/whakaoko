...
public class InstagramIT {
    ...
    public InstagramIT() {
        this.api = new InstagramApi(new HttpFetcher());
    }
    ...
    public void canSubscribe() throws Exception {
        try {
            api.createTagSubscription("twickenham", CLIENT_ID, CLIENT_SECRET, "http://localhost/instagram/callback", "a-channel", "t");
    ...
    public void canUnsubscribeAll() throws Exception {
        InstagramApi api = new InstagramApi(new HttpFetcher());
        try {
