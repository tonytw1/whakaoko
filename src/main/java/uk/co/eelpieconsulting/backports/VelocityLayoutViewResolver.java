...
package uk.co.eelpieconsulting.backports;
 ...
 * @since 1.2.7
 * @see uk.co.eelpieconsulting.backports.VelocityViewResolver
 * @see uk.co.eelpieconsulting.backports.VelocityLayoutView
 * @see #setLayoutUrl
 * @see #setLayoutKey
 * @see #setScreenContentKey
 */
public class VelocityLayoutViewResolver extends uk.co.eelpieconsulting.backports.VelocityViewResolver {
	...
	protected Class<?> requiredViewClass() {
		return uk.co.eelpieconsulting.backports.VelocityLayoutView.class;
	}
	 ...
	 * root directory)
	 * @see uk.co.eelpieconsulting.backports.VelocityLayoutView#setLayoutUrl
	 */
	 ...
	 * @see uk.co.eelpieconsulting.backports.VelocityLayoutView#setLayoutKey
	 */
	 ...
	 * @see uk.co.eelpieconsulting.backports.VelocityLayoutView#setScreenContentKey
	 */
	...
	protected AbstractUrlBasedView buildView(String viewName) throws Exception {
		uk.co.eelpieconsulting.backports.VelocityLayoutView view = (uk.co.eelpieconsulting.backports.VelocityLayoutView) super.buildView(viewName);
