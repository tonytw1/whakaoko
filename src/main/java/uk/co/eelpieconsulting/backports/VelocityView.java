 ...
 * @author Dave Syer
 * @see uk.co.eelpieconsulting.backports.VelocityConfig
 * @see uk.co.eelpieconsulting.backports.VelocityConfigurer
 * @see #setUrl
...
public class VelocityView extends AbstractTemplateView {
	 ...
	 * @see uk.co.eelpieconsulting.backports.VelocityToolboxView
	...
	protected VelocityEngine autodetectVelocityEngine() throws BeansException {
		try {
			uk.co.eelpieconsulting.backports.VelocityConfig velocityConfig = BeanFactoryUtils.beanOfTypeIncludingAncestors(
					getApplicationContext(), uk.co.eelpieconsulting.backports.VelocityConfig.class, true, false);
	 ...
	 * <p>Have a look at {@link uk.co.eelpieconsulting.backports.VelocityToolboxView}, which pre-implements
	 ...
	 * <p>Have a look at {@link uk.co.eelpieconsulting.backports.VelocityToolboxView}, which pre-implements such a
